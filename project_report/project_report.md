...
![](figures/images_data/pixel_dist_c10.jpeg)   
  
For CIFAR-100:  
  
![](figures/images_data/pixel_dist_c100.jpeg)  
...
The quantity of instances in training/validation/test sets for CIFAR-10 :  
  
![](figures/images_data/tvt_labels_c10.jpeg)  
  
For CIFAR-100 in training loader:   
  
![](figures/images_data/class_dist_c100.jpeg)  
  
The approximately uniform class distribution ensures that no class dominates the training process, supporting balanced learning and improved generalization across all classes.
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Figure 3(a):** Comparison between standard convolution and depthwise separable convolution, illustrating how spatial filtering and channel mixing are combined in standard convolution but separated into depthwise and pointwise operations in the depthwise separable case. | **Figure 3(b):** Block diagram of a depthwise separable convolution, showing the sequential application of depthwise convolution followed by pointwise (1×1) convolution for efficient feature extraction. |
